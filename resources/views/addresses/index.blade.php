...
@section('content')
    ...
    <h1 class="h3 mb-2 text-gray-800">Adresy</h1>
    <a class="btn btn-success btn-icon-split mb-1" href="{{ route('addresses.create') }}">
        <span class="icon text-white-50">
            <i class="far fa-file"></i>
        </span>
        <span class="text">Přidat adresu</span>
    </a>

    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Všechny adresy</h6>
        </div>
        <div class="card-body">
