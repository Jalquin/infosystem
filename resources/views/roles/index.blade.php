...
@section('content')
    ...
    <h1 class="h3 mb-2 text-gray-800">Osoby - Role</h1>
    <a class="btn btn-success btn-icon-split mb-1" href="{{ route('roles.create') }}">
        <span class="icon text-white-50">
            <i class="far fa-file"></i>
        </span>
        <span class="text">Přidat roli</span>
    </a>

    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Všechny role</h6>
        </div>
        <div class="card-body">
                            ...
                            <td>
                                <form action="{{ route('roles.destroy',$role->id) }}" method="POST">
                                    ...
                                    <button type="button" class="btn btn-danger btn-icon-split" data-toggle="modal"
                                            data-target="#deleteModalForId{{$role->id}}">
                                        <span class="icon text-white-50">
                                    ...
                                    <div class="modal fade" id="deleteModalForId{{$role->id}}" tabindex="-1"
