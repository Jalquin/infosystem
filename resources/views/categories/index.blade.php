                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('categories.destroy',$category->id) }}" method="POST">
                                    ...
                                    <a class="btn btn-info" href="{{ route('categories.show',$category->id) }}">Zobrazit</a>

                                    <a class="btn btn-primary" href="{{ route('categories.edit',$category->id) }}">Upravit</a>

                                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteModalForId{{$category->id}}">Smazat</button>

                                    <div class="modal fade" id="deleteModalForId{{$category->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">Opravdu chcete smazat položku {{$category->name}}?</div>
