...
@section('content')
    ...
    <a class="btn btn-success btn-icon-split mb-1" href="{{ route('companies.create') }}">
        <span class="icon text-white-50">
            <i class="far fa-file"></i>
        </span>
        <span class="text">Přidat firmu</span>
    </a>

    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Všechny firmy</h6>
        </div>
        <div class="card-body">
