...
@section('content')
    ...
    <a class="btn btn-success btn-icon-split mb-1" href="{{ route('address_types.create') }}">
        ...
        <span class="text">Přidat typ adresy</span>
    </a>

    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Všechny typy adres</h6>
        </div>
        <div class="card-body">
                            ...
                            <td>
                                <form action="{{ route('address_types.destroy',$addressType->id) }}" method="POST">
                                    ...
                                    <button type="button" class="btn btn-danger btn-icon-split" data-toggle="modal"
                                            data-target="#deleteModalForId{{$addressType->id}}">
                                        <span class="icon text-white-50">
                                    ...
                                    <div class="modal fade" id="deleteModalForId{{$addressType->id}}" tabindex="-1"
